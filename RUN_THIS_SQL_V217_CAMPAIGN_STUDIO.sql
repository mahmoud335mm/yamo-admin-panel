...
-- Preserve the five original Yamo banners as real, manageable campaigns.
insert into public.yamo_campaigns(id,kind,title_ar,body_ar,image_url,content_mode,destination_type,destination_value,segment,placement,button_ar,scheduled_at,enabled)
values
('13830000-0000-4000-8000-000000000001','banner','صوتك ليه مكان','ادخل غرف يامو وشارك بصوتك','asset://home_banner_voice','image_text','room',null,'all','home','اكتشف الآن','2026-01-01',true),
('13830000-0000-4000-8000-000000000002','banner','شارك لحظتك','صور وفيديوهات من مجتمع يامو','asset://home_banner_posts','image_text','page','posts','all','home','شارك الآن','2026-01-01',true),
('13830000-0000-4000-8000-000000000003','banner','حدث اليوم','العب وتحدّى واربح جوائز مميزة','asset://home_banner_event','image_text','event',null,'all','home','افتح الحدث','2026-01-01',true),
('13830000-0000-4000-8000-000000000004','banner','وكالتك في يامو','تابع فريقك وإنجازاتك','asset://home_banner_agency','image_text','agency',null,'all','home','اعرف أكتر','2026-01-01',true),
('13830000-0000-4000-8000-000000000005','banner','مزايا VIP الحصرية','إطارات ودخوليات ومكافآت مميزة','asset://home_banner_vip','image_text','page','vip','all','home','اكتشف VIP','2026-01-01',true)
on conflict(id) do update set title_ar=excluded.title_ar,body_ar=excluded.body_ar,image_url=excluded.image_url,content_mode=excluded.content_mode,destination_type=excluded.destination_type,destination_value=excluded.destination_value,placement=excluded.placement,button_ar=excluded.button_ar;
